...
def multiprocessing_func(x, pe):
    ...
    try:
        ...
        for row in c:
            ...
            sql = "select distinct ZTE_PORT,HUAWEI_PORT,NOKIA_PORT,V_PORT,REGID,DNAME,SPEED,ZTE_PROFILE from ONEG_NEWCCT_DETAILS " \
                  "where PE_NO= :PE_NO  and ONT_SN= :ONT_SN and REGID= :REGID"
